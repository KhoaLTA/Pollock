                ...
                for (e in s[n])
                    (i = s[n][e]),
                        a.call(s[n], e) &&
                            void 0 !== i &&
                            (V.isPlainObject(i)
                                ? (t[e] = V.isPlainObject(t[e]) ? V.widget.extend({}, t[e], i) : V.widget.extend({}, i))
                                : (t[e] = i));
            return t;
        }),
                                  ...
                                  : function (t, i) {
                                        ...
                                        w(i.props, function (t, e) {
                                            ...
                                            o[s] &&
                                                ...
                                                (null == o[s][3] && (o[s][3] = 1), i.from && (o._rgba = i.from(o[s])));
                                    },
                          ),
                          this)
                        : void 0
    ...
    (V.effects = { effect: {} }),
                ...
                removeWrapper: function (t) {
                    ...
                    return (
                        t.parent().is('.ui-effects-wrapper') &&
                            (t.parent().replaceWith(t), (t[0] !== e && !V.contains(t[0], e)) || V(e).trigger('focus')),
                        t
                    );
                },
            }),
        V.extend(V.effects, {
            ...
            mode: function (t, e) {
                t = t.is(':hidden');
                return (
                    'toggle' === e && (e = t ? 'show' : 'hide'), (e = (t ? 'hide' === e : 'show' === e) ? 'none' : e)
                );
            },
        ...
        V.effects.define('fold', 'hide', function (e, t) {
            ...
            r && (a = (parseInt(r[1], 10) / 100) * f[o ? 0 : 1]),
                ...
                i
                    .queue(function (t) {
                        c &&
                            c.animate(V.effects.clipToBox(d), h, e.easing).animate(V.effects.clipToBox(p), h, e.easing),
                            t();
                    })
                ...
                switch (t.keyCode) {
                    ...
                    default:
                        (e = this.previousFilter || ''),
                            ...
                            (e = s && -1 !== e.index(this.active.next()) ? this.active.nextAll('.ui-menu-item') : e)
            ...
            __response: function (t) {
                ...
                this._superApply(arguments),
                    this.options.disabled ||
                        this.cancelSearch ||
                        ((e =
                            t && t.length ? this.options.messages.results(t.length) : this.options.messages.noResults),
                        clearTimeout(this.liveRegionTimer),
                        (this.liveRegionTimer = this._delay(function () {
            ...
            _readType: function () {
                ...
                (this.type = this.element[0].type),
                    ('input' === t && /radio|checkbox/.test(this.type)) ||
                        V.error(
                            "Can't create checkboxradio on element.nodeName=" + t + ' and element.type=' + this.type,
                        );
            },
            _enhance: function () {
    ...
    V.extend(V.ui, { datepicker: { version: '1.13.2' } }),
        V.extend(st.prototype, {
            ...
            parseDate: function (e, n, t) {
                ...
                if (
                    (-1 === d
                        ...
                        : d < 100 &&
                          (d += new Date().getFullYear() - (new Date().getFullYear() % 100) + (d <= r ? 0 : -100)),
                    -1 < g)
                )
                    for (p = 1, f = g; ; ) {
                    ...
                    for (_ = '', this.maxRows = 4, v = 0; v < L[1]; v++) {
                        ...
                        11 < ++K && ((K = 0), U++),
                            (_ += w +=
                                ...
                                (Y
                                    ? '</div>' +
                                      (0 < L[0] && v === L[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                                    : ''));
                    }
                    f += _;
                }
            ...
            _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
                ...
                return (
                    (b += this._get(t, 'yearSuffix')), m && (b += (!o && f && g ? '' : '&#xa0;') + y), (b += '</div>')
                );
            },
        ...
        (V.fn.datepicker = function (t) {
            ...
            V.datepicker.initialized ||
                (V(document).on('mousedown', V.datepicker._checkExternalClick), (V.datepicker.initialized = !0)),
    ...
    V.widget('ui.droppable', {
        ...
        _setOption: function (t, e) {
            ...
            'accept' === t
                ...
                : 'scope' === t &&
                  ((i = V.ui.ddmanager.droppables[this.options.scope]), this._splice(i), this._addToManager(e)),
                this._super(t, e);
        },
        _activate: function (t) {
        ...
        V.widget('ui.selectmenu', [
            V.ui.formResetMixin,
            {
                ...
                _documentClick: {
                    mousedown: function (t) {
                        this.isOpen &&
                            (V(t.target).closest('.ui-selectmenu-menu, #' + V.escapeSelector(this.ids.button)).length ||
                                this.close(t));
                    },
                },
                _buttonEvents: {
            ...
            _mouseStart: function (t, e, i) {
                ...
                if (
                    ...
                    o.cursor &&
                        ...
                        (this.storedStylesheet = V('<style>*{ cursor: ' + o.cursor + ' !important; }</style>').appendTo(
                            n,
                        ))),
                    o.zIndex &&
    ...
    V.widget('ui.tabs', {
        ...
        _panelKeydown: function (t) {
            this._handlePageNav(t) ||
                (t.ctrlKey && t.keyCode === V.ui.keyCode.UP && (t.preventDefault(), this.active.trigger('focus')));
        },
